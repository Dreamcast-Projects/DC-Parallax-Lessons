...
int main(int argc, char **argv) {
	...
	while(1) {
		...
		plx_vert_inpm3(PLX_VERT, 0, 1, 0, plx_pack_color(1.0f, 1.0f, 1.0f, 1.0f));       // Top 
		plx_vert_inpm3(PLX_VERT,  -1,  -1, 0, plx_pack_color(1.0f, 1.0f, 1.0f, 1.0f));   // Bottom Left
		plx_vert_inpm3(PLX_VERT_EOS,  1, -1, 0, plx_pack_color(1.0f, 1.0f, 1.0f, 1.0f)); // Bottom Right
		...
		plx_vert_inpm3(PLX_VERT, -1,  1, 0, plx_pack_color(1.0f, 1.0f, 1.0f, 1.0f));       // Bottom Left
		plx_vert_inpm3(PLX_VERT, -1, -1, 0, plx_pack_color(1.0f, 1.0f, 1.0f, 1.0f));       // Top Left
		plx_vert_inpm3(PLX_VERT,  1,  1, 0, plx_pack_color(1.0f, 1.0f, 1.0f, 1.0f));       // Bottom Right
		plx_vert_inpm3(PLX_VERT_EOS,  1, -1, 0, plx_pack_color(1.0f, 1.0f, 1.0f, 1.0f));   // Top Right
